...
# =========================================================
    ...
    # 아이폰 캘린더 스타일 CSS (테두리 완전 제거 및 명확한 글자색 지정)
    cal_html = """
    <style>
    .iphone-table {
        width: 100% !important;
    ...
    .iphone-date-link:hover {
        background-color: rgba(128, 128, 128, 0.15) !important;
    }
    .iphone-date-link.selected {
        background-color: #ff3b30 !important;
        color: #ffffff !important;
        font-weight: bold !important;
    }
    
    .iphone-sun { color: #ff3b30 !important; }
    .iphone-sat { color: #007aff !important; }
    ...
    .iphone-date-link.selected .iphone-dot {
    ...
    for week_idx, week in enumerate(cal):
        ...
        for day_idx, day in enumerate(week):
            if day == 0:
                ...
                dot_html = "<div class='iphone-dot'></div>" if has_log else "<div style='height: 3px; margin-top: 1px; visibility: hidden;'>•</div>"
                btn_cls = "iphone-date-link selected" if cur_d_str == sel_date_str else "iphone-date-link"
